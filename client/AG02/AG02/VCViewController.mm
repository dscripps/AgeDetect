...
- (void)processFrame:(cv::Mat&)mat img:(UIImage*)img videoRect:(CGRect)rect videoOrientation:(AVCaptureVideoOrientation)orientation;
       ...
       fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (format == kCVPixelFormatType_420YpCbCr8BiPlanarFullRange) {
        ...
        */
        ...
        [self processFrame:mat img:nil videoRect:videoRect videoOrientation:videoOrientation];
